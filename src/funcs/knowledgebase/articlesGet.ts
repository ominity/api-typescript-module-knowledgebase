...
import {
    GetArticleRequest,
    GetArticleRequest$outboundSchema,
...
> {
    const parsed = safeParse(
        request,
        (value) => GetArticleRequest$outboundSchema.parse(value),
    ...
    const path = `/modules/knowledgebase/articles/${payload.id}`;
    ...
    const context = {
        ...
        operationID: "modules.knowledgebase.articles.get",
        oAuth2Scopes: null,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, KnowledgebaseArticle$inboundSchema, {
