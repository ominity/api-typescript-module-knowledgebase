...
import {
    ...
    KnowledgebaseArticlesListResponse$inboundSchema,
} from "../../models/knowledgebase/article.js";
import {
    ListArticlesRequest,
    ArticlesListParams$outboundSchema,
} from "../../models/operations/knowledgebase-articles.js";
...
export function articlesList(
    client: ClientSDK,
    request?: ListArticlesRequest | undefined,
...
> {
    const parsed = safeParse(
        request,
        (value) => ArticlesListParams$outboundSchema.parse(value),
    ...
    const path = "/modules/knowledgebase/articles";
    ...
    const context = {
        ...
        operationID: "modules.knowledgebase.articles.list",
        oAuth2Scopes: null,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, KnowledgebaseArticlesListResponse$inboundSchema, {
